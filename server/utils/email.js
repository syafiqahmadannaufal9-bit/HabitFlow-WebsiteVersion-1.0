...
const sendPasswordResetEmail = async (toEmail, resetToken) => {
    ...
    const mailOptions = {
        from: process.env.SMTP_FROM || '"HabitFlow Support" <no-reply@habitflow.com>',
        to: toEmail,
        subject: 'Password Reset Request - HabitFlow',
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
                <h2 style="color: #10B981; text-align: center;">Reset Your Password</h2>
                <p style="color: #333; font-size: 16px;">Hello,</p>
                <p style="color: #333; font-size: 16px;">We received a request to reset the password for your HabitFlow account. If you didn't make this request, you can safely ignore this email.</p>
                ...
                <p style="color: #999; font-size: 12px; text-align: center;">&copy; ${new Date().getFullYear()} HabitFlow.</p>
            </div>
        `
    };
